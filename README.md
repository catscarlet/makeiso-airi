...
- A CentOS-7-x86_64-Everything-1804.iso image
- genisoimage (A RPM package is included in Everything 1804 iso image)
- createrepo (A RPM package is included in Everything 1804 iso image)
- rsync 3.1.1+ (A version 3.1.2 of rsync RPM package is included in Everything 1804 iso image)
...
- **CENTOS7_EVERYTHING_ISO** Must be a accessiable CentOS-7-x86_64-Everything-1804.iso files.
...
And you will get a ISO file. The default root password is 'makeiso-airi'.
...
- centos_dvd_frame.list , CentOS-7-1804 DVD frameware files.
...
### Idea about naming this 'make linux iso project' Airi
...
Makeiso-Airi is licensed under Anti-996-License, which is adapted from the MIT license.
